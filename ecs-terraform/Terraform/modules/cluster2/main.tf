...
resource "aws_ecs_cluster" "connector" {
  name = "${var.CONNECTOR_CLUSTER_NAME_ZONEB}"
}
resource "aws_ecs_cluster" "service" {
  name = "${var.SERVICE_CLUSTER_NAME_ZONEB}"
}
#
# ECS Service Depends_On Iam roles and Policy
#
resource "aws_iam_role_policy" "ecs_role_policy" {
  name = "${var.STACK}ECS_DEPENDS_ROLE_POLICY_ZONEB"
...
resource "aws_iam_role" "ecs_role" {
  name = "${var.STACK}-ECS_DEPENDS_ROLE-ZONEB"
